...
function regformhash(form, uid, email, password, conf) {
	...
	if(!re.test(password.value)) {
		alert('Password must contain at least one number, one lowercase and one uppercase letter. Please try again.');
		return FALSE;
	}
	...
	// Make sure the plaintext password dosen't get sent.
	password.value = "";
	conf.value = "";
